...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter Username", placeholder="krishna")
...
def teacer_screen_register():
    ...
    teacher_name = st.text_input("Enter name", placeholder="Krishna")
